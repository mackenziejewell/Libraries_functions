...
def grab_OSISAF_drift(date=datetime(2000,1,1), main_path = '/Volumes/Seagate_Jewell/KenzieStuff/OSI-SAF/'):
...
06-19-2024
    ...
    data = {}
    data['proj'] = grab_projinfo_OSISAF(ds)
